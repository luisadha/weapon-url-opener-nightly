...
CATCH_URL="${TERMUX_URL_OPENER_SHARED_DATA:-"Please share the link, and I’ll take care of the rest."}"
VERSION="v2.5.1"
DEBUG=0
lang=""
...
declare -A map_id=(
  [info_t]='Gunakan ↑ ↓ untuk navigasi, Enter untuk pilih'
...
# Map Bahasa Inggris
declare -A map_en=(
  [info_t]='Use ↑↓ to navigate, Enter to select'
...
# --> </code></pre><h3>Bermain di Termux</h3><div class="share-line"><span>Salin kode di bawah atau</span><button onclick="share()"><img src="./assets/img/share-icon.png" alt="Share Icon" width="11px" height="11px"> Bagikan ke Termux (harus Nene-Ak47)</button>  </div> <pre>    <code class="language-shell">. &lt;(curl -L luisadha.github.io/weapon-url-opener-nightly)</code></pre>   <div class="note">       <strong>Catatan: </strong>       Agar tombol <em>Bagikan ke Termux</em>      berfungsi dengan benar, kamu harus mengganti handler   </div> <code>termux-url-opener</code>ke Nene-Ak47. Panduan lengkap silahkan baca di <a href="https://github.com/luisadha/nene#api">https://github.com/luisadha/nene#api</a>       <footer>          <p> (C) 2021–2025            <a href="https://luisadha.my.id">luisadha.my.id</a>          <a href="https://github.com/luisadha">github.com/luisadha</a>           </p>       </footer>           </body>           </html>
